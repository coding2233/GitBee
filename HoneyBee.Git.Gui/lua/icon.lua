local fileIcons = {}
fileIcons["file_type_text"] = {".txt"}
fileIcons["file_type_log"] = {".log"}
fileIcons["file_type_config"] = {".ini",".conf",".config"}
fileIcons["file_type_json"] = {".json"}
fileIcons["file_type_c"] = {".c",".C"}
fileIcons["file_type_cheader"] = {".h"}
fileIcons["file_type_cpp"] = {".h++",".hpp",".cpp"}
...
fileIcons["file_type_yaml"] = {".yaml",".yml",".meta"}
fileIcons["file_type_xml"] = {".xml"}
fileIcons["file_type_fbx"] = {".fbx",".FBX"}
