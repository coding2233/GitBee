...
void FileTreePanel::SetRepository(std::shared_ptr<GitRepository> repo)
{
...
void FileTreePanel::LoadFileTree()
{
...
void FileTreePanel::LoadDirectory(const std::string& path, std::vector<FileTreeNode>& out)
{
    try
    {
...
void FileTreePanel::RenderTreeNode(const FileTreeNode& node)
{
